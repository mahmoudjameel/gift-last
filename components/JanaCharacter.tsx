...
const searchGreetings = {
  ar: ['هلا! وش تدور عليه؟', 'أهلين! قولي وش تبي', 'مرحبا! خلني أساعدك تلاقي', 'هلا وغلا! ابحث وأنا معك'],
  he: ['היי! מה בא לך לחפש?', 'אהלן! תגיד/י לי מה צריך', 'שלום! אני אעזור לך למצוא', 'יאללה, חפש/י ואני איתך'],
};

const smartTips = {
  ar: ['شفت العروض اليوم؟ تستاهل!', 'وصلتنا باقات جديدة مره حلوة!', 'خلني أدلك على الأفضل', 'قولي وش تبي وأنا أبحث لك!'],
...
const cartCTAs = {
  ar: ['أضيفه للسلة! ما راح تندم 🛒', 'يلا أضفه قبل لا يخلص!', 'لا تتردد، أضفه الحين!', 'هالمنتج يستاهل! خذه', 'خذه هدية، بيفرح أحبابك!', 'وش تنتظر؟ أضفه للسلة!'],
...
export function getJanaSmartMessage(context: {
  ...
  if (searchQuery && searchQuery.trim().length > 0) {
    if (hasResults) {
      if (searchType === 'product') {
        const msgs = isArabic
          ? ['واو لقيت لك شي حلو! 🔍', 'شوف هالنتايج، ذوقك عالي!', 'عندك اختيارات حلوة ما شاء الله!', 'تبي رأيي؟ كلهم حلوين! 😍']
  ...
  const defaultMsgs = isArabic
    ? ['ابحث عن اسم المنتج أو المتجر 🔍', 'وش تبي تدور عليه اليوم؟', 'خلني أساعدك تلاقي اللي تبيه!']
